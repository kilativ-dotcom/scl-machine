...
namespace InferenceManagerTestWithoutReplacements
{
ScsLoader loader;
...
using InferenceManagerTestWithoutReplacements = ScMemoryTest;
...
TEST_F(InferenceManagerTestWithoutReplacements, SuccessApplyInference)
{
  ...
  InferenceConfig const & inferenceConfig{
      GENERATE_UNIQUE_FORMULAS, REPLACEMENTS_FIRST, TREE_ONLY_OUTPUT_STRUCTURE, SEARCH_IN_STRUCTURES, GENERATED_ONLY, SEARCH_WITHOUT_REPLACEMENTS};
...
TEST_F(InferenceManagerTestWithoutReplacements, SuccessGenerateInferenceConclusion)
{
  ScMemoryContext & context = *m_ctx;
  ...
  InferenceConfig const & inferenceConfig{
      GENERATE_UNIQUE_FORMULAS, REPLACEMENTS_FIRST, TREE_ONLY_OUTPUT_STRUCTURE, SEARCH_IN_ALL_KB, GENERATED_ONLY, SEARCH_WITHOUT_REPLACEMENTS};
  ScAddrVector const & argumentVector = utils::IteratorUtils::getAllWithType(&context, argumentSet, ScType::Node);
  ScAddr const & outputStructure = context.CreateNode(ScType::NodeConstStruct);
...
TEST_F(InferenceManagerTestWithoutReplacements, RuleNotUsed)
{
  ScMemoryContext & context = *m_ctx;
...
TEST_F(InferenceManagerTestWithoutReplacements, TargetNotAchieved)
{
  ScMemoryContext & context = *m_ctx;
...
TEST_F(InferenceManagerTestWithoutReplacements, ReplacementsTest)
{
  ScMemoryContext & context = *m_ctx;
...
TEST_F(InferenceManagerTestWithoutReplacements, DISABLED_ConclusionArgumentsTest)
{
  ScMemoryContext & context = *m_ctx;
...
TEST_F(InferenceManagerTestWithoutReplacements, SolutionOutputStrcuture)
{
  ScMemoryContext & context = *m_ctx;
