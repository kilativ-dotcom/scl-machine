...
namespace InferenceManagerBuilderTestWithoutReplacements
{
ScsLoader loader;
...
using InferenceManagerBuilderTestWithoutReplacements = ScMemoryTest;
...
TEST_F(InferenceManagerBuilderTestWithoutReplacements, SingleSuccessApplyInference)
{
  ...
  InferenceConfig const & inferenceConfig{
      GENERATE_ALL_FORMULAS, REPLACEMENTS_ALL, TREE_ONLY_OUTPUT_STRUCTURE, SEARCH_IN_STRUCTURES, GENERATED_ONLY, SEARCH_WITHOUT_REPLACEMENTS};
...
TEST_F(InferenceManagerBuilderTestWithoutReplacements, GenerateNotUnique)
{
  ScMemoryContext & context = *m_ctx;
...
TEST_F(InferenceManagerBuilderTestWithoutReplacements, GenerateUnique)
{
  ScMemoryContext & context = *m_ctx;
  ...
  InferenceConfig const & inferenceConfig{
      GENERATE_UNIQUE_FORMULAS, REPLACEMENTS_ALL, TREE_ONLY_OUTPUT_STRUCTURE, SEARCH_IN_STRUCTURES, GENERATED_ONLY, SEARCH_WITHOUT_REPLACEMENTS};
  std::unique_ptr<inference::InferenceManagerAbstract> iterationStrategy =
      inference::InferenceManagerFactory::constructDirectInferenceManagerAll(&context, inferenceConfig);
...
// Logical formula is not generated because of generateOnlyUnique = true flag
TEST_F(InferenceManagerBuilderTestWithoutReplacements, GenerateUniqueWithOutputStructure)
{
  ScMemoryContext & context = *m_ctx;
...
TEST_F(InferenceManagerBuilderTestWithoutReplacements, GenerateNotFirst)
{
  ScMemoryContext & context = *m_ctx;
...
TEST_F(InferenceManagerBuilderTestWithoutReplacements, GenerateFirst)
{
  ScMemoryContext & context = *m_ctx;
  ...
  InferenceConfig const & inferenceConfig{
      GENERATE_ALL_FORMULAS, REPLACEMENTS_FIRST, TREE_ONLY_OUTPUT_STRUCTURE, SEARCH_IN_STRUCTURES, GENERATED_ONLY, SEARCH_WITHOUT_REPLACEMENTS};
  std::unique_ptr<inference::InferenceManagerAbstract> iterationStrategy =
      inference::InferenceManagerFactory::constructDirectInferenceManagerAll(&context, inferenceConfig);
...
TEST_F(InferenceManagerBuilderTestWithoutReplacements, notGenerateSolutionTree)
{
  ScMemoryContext & context = *m_ctx;
...
TEST_F(InferenceManagerBuilderTestWithoutReplacements, generateSolutionTree)
{
  ScMemoryContext & context = *m_ctx;
  ...
  // Create inference manager with `strategy all` using director
  InferenceConfig const & inferenceConfig{GENERATE_ALL_FORMULAS, REPLACEMENTS_ALL, TREE_FULL, SEARCH_IN_STRUCTURES, GENERATED_ONLY, SEARCH_WITHOUT_REPLACEMENTS};
  std::unique_ptr<inference::InferenceManagerAbstract> iterationStrategy =
      inference::InferenceManagerFactory::constructDirectInferenceManagerAll(&context, inferenceConfig);
...
TEST_F(InferenceManagerBuilderTestWithoutReplacements, SingleUnsuccessfulApplyInference)
{
  ScMemoryContext & context = *m_ctx;
...
TEST_F(InferenceManagerBuilderTestWithoutReplacements, SingleSuccessfulApplyInferenceWithAccessEdgesSearcher)
{
  ScMemoryContext & context = *m_ctx;
  ...
  InferenceConfig const & inferenceConfig{
      GENERATE_ALL_FORMULAS, REPLACEMENTS_ALL, TREE_ONLY_OUTPUT_STRUCTURE, SEARCH_ONLY_ACCESS_EDGES_IN_STRUCTURES, GENERATED_ONLY, SEARCH_WITHOUT_REPLACEMENTS};
  std::unique_ptr<inference::InferenceManagerAbstract> iterationStrategy =
      inference::InferenceManagerFactory::constructDirectInferenceManagerAll(&context, inferenceConfig);
...
TEST_F(InferenceManagerBuilderTestWithoutReplacements, OutputStructureContainsGeneratedAndFlagIsGenerated)
{
  ScMemoryContext & context = *m_ctx;
...
TEST_F(InferenceManagerBuilderTestWithoutReplacements, OutputStructureContainsGeneratedButFlagIsSearchedAndGenerated)
{
  ScMemoryContext & context = *m_ctx;
  ...
  InferenceConfig const & inferenceConfig{
      GENERATE_ALL_FORMULAS, REPLACEMENTS_ALL, TREE_ONLY_OUTPUT_STRUCTURE, SEARCH_ONLY_ACCESS_EDGES_IN_STRUCTURES, SEARCHED_AND_GENERATED, SEARCH_WITHOUT_REPLACEMENTS};
  std::unique_ptr<inference::InferenceManagerAbstract> iterationStrategy =
      inference::InferenceManagerFactory::constructDirectInferenceManagerAll(&context, inferenceConfig);
...
TEST_F(InferenceManagerBuilderTestWithoutReplacements, OutputStructureContainsSearchedAndFlagIsSearchedAndGenerated)
{
  ScMemoryContext & context = *m_ctx;
  ...
  InferenceConfig const & inferenceConfig{
      GENERATE_UNIQUE_FORMULAS, REPLACEMENTS_ALL, TREE_ONLY_OUTPUT_STRUCTURE, SEARCH_ONLY_ACCESS_EDGES_IN_STRUCTURES, SEARCHED_AND_GENERATED, SEARCH_WITHOUT_REPLACEMENTS};
  std::unique_ptr<inference::InferenceManagerAbstract> iterationStrategy =
      inference::InferenceManagerFactory::constructDirectInferenceManagerAll(&context, inferenceConfig);
...
TEST_F(InferenceManagerBuilderTestWithoutReplacements, OutputStructureDoesNotContainSearchedBecauseFlagIsGenerated)
{
  ScMemoryContext & context = *m_ctx;
  ...
  InferenceConfig const & inferenceConfig{
      GENERATE_UNIQUE_FORMULAS, REPLACEMENTS_ALL, TREE_ONLY_OUTPUT_STRUCTURE, SEARCH_ONLY_ACCESS_EDGES_IN_STRUCTURES, GENERATED_ONLY, SEARCH_WITHOUT_REPLACEMENTS};
  std::unique_ptr<inference::InferenceManagerAbstract> iterationStrategy =
      inference::InferenceManagerFactory::constructDirectInferenceManagerAll(&context, inferenceConfig);
...
TEST_F(InferenceManagerBuilderTestWithoutReplacements, OutputStructureContainsSearchedAndGeneratedAndFlagIsSearchedAndGenerated)
{
  ScMemoryContext & context = *m_ctx;
